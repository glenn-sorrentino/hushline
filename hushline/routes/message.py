...
from hushline.routes.common import compose_message_email_body, do_send_email
...
def register_message_routes(app: Flask) -> None:
    ...
    def resend_message(public_id: str) -> Response:
        ...
        email_body = compose_message_email_body(user, extracted_fields)
        do_send_email(user, email_body.strip())
        flash("✉️ Email resent successfully.")
        return redirect(url_for("message", public_id=public_id))
